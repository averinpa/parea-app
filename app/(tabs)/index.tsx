...
const MOCK_EVENTS = [
  ...
  { id: 14, city: 'Limassol', type: 'official',   title: 'Limassol Jazz & Blues Festival',       time: 'Today, 20:00',   distance: '1km',   category: 'music',   gradient: ['#1a1a2e', '#16213e'], seekerColors: ['#818CF8', '#f472b6'],                      seekingCount: 22, participantsCount: 180, maxParticipants: 300, organizer: { name: 'Rialto Theatre',            emoji: '🎷' }, ticketLink: 'https://rialto.com.cy/jazz-fest',          source: 'Rialto Theatre',   description: 'Three-night outdoor jazz and blues festival at the Rialto courtyard. Featuring local and international acts. Bar open, seating limited — come early.' },
  { id: 15, city: 'Limassol', type: 'official',   title: 'Street Art Walking Tour',              time: 'Tomorrow, 11:00',distance: '0.3km', category: 'culture', gradient: ['#f953c6', '#b91d73'], seekerColors: ['#a78bfa', '#34d399', '#f97316'],           seekingCount: 8,  participantsCount: 12,  maxParticipants: 20,  organizer: { name: 'Limassol Arts Council',     emoji: '🎨' }, ticketLink: null,                                         source: 'Official Website', description: 'Guided 2-hour walking tour of Limassol\'s murals and street art scene. English and Russian guided options. Ends at a local gallery with free drinks.' },
  { id: 16, city: 'Limassol', type: 'official',   title: 'Padel Open Tournament',                time: 'Sat, 09:00',     distance: '2.5km', category: 'sports',  gradient: ['#11998e', '#38ef7d'], seekerColors: ['#22c55e', '#818CF8', '#f97316'],           seekingCount: 6,  participantsCount: 24,  maxParticipants: 32,  organizer: { name: 'Limassol Padel Club',        emoji: '🏓' }, ticketLink: 'https://limassolpadel.cy/open',            source: 'Official Website', description: 'Amateur padel doubles tournament, mixed & open categories. Registration includes post-tournament BBQ and drinks at the club.' },
  { id: 17, city: 'Limassol', type: 'official',   title: 'Latin Dance Festival',                 time: 'Sat, 19:00',     distance: '1.5km', category: 'dance',   gradient: ['#fc5c7d', '#6a3093'], seekerColors: ['#f472b6', '#a78bfa', '#f97316'],           seekingCount: 34, participantsCount: 90,  maxParticipants: 200, organizer: { name: 'Parea Dance Events',         emoji: '💃' }, ticketLink: 'https://soldout.com.cy/latin-dance',       source: 'SoldOut Tickets',  description: 'Cyprus\'s biggest Latin night with workshops in bachata, salsa, and kizomba from 19:00 followed by a 4-hour social. All levels and nationalities welcome.' },
  { id: 18, city: 'Limassol', type: 'official',   title: 'Specialty Coffee Fair',                time: 'Sun, 10:00',     distance: '0.6km', category: 'coffee',  gradient: ['#c79081', '#dfa579'], seekerColors: ['#818CF8', '#4CAF50'],                      seekingCount: 15, participantsCount: 60,  maxParticipants: 200, organizer: { name: 'Cyprus Barista Guild',       emoji: '☕' }, ticketLink: null,                                         source: 'Official Website', description: 'Free-entry specialty coffee fair with 15 roasters, brewing demos, and barista competitions. The best single-origin coffee event on the island.' },
  { id: 19, city: 'Limassol', type: 'official',   title: 'Troodos Trail Run 10K',                time: 'Sun, 08:00',     distance: '5km',   category: 'outdoors',gradient: ['#56ccf2', '#2f80ed'], seekerColors: ['#22c55e', '#334155', '#818CF8'],           seekingCount: 20, participantsCount: 110, maxParticipants: 250, organizer: { name: 'Cyprus Trail Series',        emoji: '🏃' }, ticketLink: 'https://cyprustrial.cy/troodos10k',        source: 'Official Website', description: '10K trail run through the Troodos pine forest. Chip-timed, medal finishers, aid stations every 2.5km. Beginner-friendly pace groups available.' },
  { id: 20, city: 'Limassol', type: 'official',   title: 'Retro Gaming Expo',                    time: 'Sun, 12:00',     distance: '2km',   category: 'gaming',  gradient: ['#4facfe', '#00f2fe'], seekerColors: ['#818CF8', '#f472b6', '#22c55e'],           seekingCount: 18, participantsCount: 45,  maxParticipants: 100, organizer: { name: 'Cyprus Gaming Society',     emoji: '🕹️' }, ticketLink: 'https://tickets.cy/retro-gaming',          source: 'Official Website', description: 'Playable exhibits from 8-bit to early 3D era. Competitions on original hardware, collectibles market, and panel talks. Free entry for under-12s.' },
  { id: 21, city: 'Limassol', type: 'official',   title: 'Mezze & Local Wine Evening',           time: 'Sun, 19:30',     distance: '0.9km', category: 'food',    gradient: ['#f7971e', '#ffd200'], seekerColors: ['#ef4444', '#9C27B0', '#818CF8'],           seekingCount: 14, participantsCount: 35,  maxParticipants: 60,  organizer: { name: 'Old Town Restaurants Assoc.',emoji: '🫒' }, ticketLink: 'https://soldout.com.cy/mezze-night',       source: 'SoldOut Tickets',  description: 'Traditional Cypriot mezze with 20+ dishes paired with Commandaria and local rosé. Held in a restored carob warehouse in the old port area.' },
]
          ...
          <LinearGradient colors={['#F5F3FF', '#EEF2FF', '#F0F9FF']} style={s.fill}>
            <View style={[s.fill, { paddingBottom: insets.bottom }]}>
              <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'height' : undefined}>
                ...
                {/* Header row */}
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingTop: insets.top + 32, paddingBottom: 12 }}>
                  <TouchableOpacity
                    onPress={() => {
                      if (createStep > 1) {
